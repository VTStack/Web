import { Title, Text, Col, Link, Card, Row } from '@v-thomas/external/core-ui';
    ...
    <Col padding="2" align="top" exit={{ opacity: 0 }} initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      <Card noHover>
        ...
        <Col gap="0.25">
          ...
          <Text>I am a 15 year old guy making web-apps and other types of softwares.</Text>
          <Text>Sailing and coding are my hobbies.</Text>
          <Text>
            I live in{' '}
            <Link
      ...
      <Card noHover onClick={() => window.open('//link.v-thomas.me/movie', '_blank')}>
        <Row align="left" gap="1">
          ...
          <Col gap="0.5">
            ...
            <Link to="//link.v-thomas.me/movie" external icon>
              movie.v-thomas.me
            </Link>
          </Col>
        </Row>
